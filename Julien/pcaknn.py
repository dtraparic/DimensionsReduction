...
for i in range(1,64,1):    
    #X_lda = discriminant_analysis.LinearDiscriminantAnalysis(n_components=i).fit_transform(X, y) 
...
#    print("EVALUATION ON TESTING DATA")
    b = precision_score(testLabels, predictions, average='weighted')
    values.append(b)
    a = classification_report(testLabels, predictions)
#    print(b)
#    print(a)
